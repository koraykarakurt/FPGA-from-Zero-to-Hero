...
set_property PACKAGE_PIN W5 [get_ports clk]							
	...
	create_clock -add -name clk -period 2.20 -waveform {0 1.10} [get_ports clk]
	
 
# Switches
set_property PACKAGE_PIN V17 [get_ports data_i]					
	set_property IOSTANDARD LVCMOS33 [get_ports data_i]
set_property PACKAGE_PIN V16 [get_ports data_o]					
...
#set_property PACKAGE_PIN R2 [get_ports {sw[15]}]					
 ...
 # False path
 set_false_path -from [get_ports data_i] -to [get_cells {gen_xilinx.sync_reg[0]/D}]
