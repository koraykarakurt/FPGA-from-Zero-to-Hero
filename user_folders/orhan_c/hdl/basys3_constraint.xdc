...
##Pmod Header JA
##Sch name = JA1
set_property PACKAGE_PIN J1 [get_ports rst_in]
set_property IOSTANDARD LVCMOS33 [get_ports rst_in]
##Sch name = JA2
set_property PACKAGE_PIN L2 [get_ports rst_out]
...
set_false_path -to [get_pins {xilinx_path.rst_chain_reg[0]}] -from [get_ports {rst_in}]
